...
$current='<?php
	...
	$select_page = selectDB($link, $db_table_02, $columnsDB_02, "name_page='."'$name_page'".'", false);//Выбор шаблона из БД
...
<!DOCTYPE html>
 ...
 <head>
	...
	<link rel="stylesheet" href="<?php echo("$page_massive[css_href_page]")?>'.$name_page.'.css"> <!--Подключаем стили данной страницы-->
	...
	<script type="text/javascript" src="<?php echo("$page_massive[js_page]")?>'.$name_page.'.js"></script> <!--Подключаем скрипты для данной страницы-->
