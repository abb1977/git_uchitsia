<?php
	...
	$select_page = selectDB($link, $db_table_admin, $columnsAdmin, "name_page='change_news_db'", false);//Выбор шаблона из БД
...
<!DOCTYPE html>
 <html>
 <head>
	<title><?php eval("$page_massive[title]")?></title>
	<meta charset="utf-8" />
	<link href="<?php eval("$page_massive[favicon]")?>" rel="shortcut icon" type="image/x-icon" />
