<?php
	...
	$select_page = selectDB($link, $db_table_02, $columnsDB_02, "name_page='ajax'", false);//Выбор шаблона из БД
...
<!DOCTYPE html>
 ...
 <head>
	...
	<link rel="stylesheet" href="<?php echo("$page_massive[css_href_page]")?>ajax.css"> <!--Подключаем стили данной страницы-->
	...
	<script type="text/javascript" src="<?php echo("$page_massive[js_page]")?>ajax.js"></script> <!--Подключаем скрипты для данной страницы-->
