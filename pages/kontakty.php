<?php
	...
	$select_page = selectDB($link, $db_table_02, $columnsDB_02, "name_page='kontakty'", false);//Выбор шаблона из БД
...
<!DOCTYPE html>
 ...
 <head>
	...
	<link rel="stylesheet" href="<?php echo("$page_massive[css_href_page]")?>kontakty.css"> <!--Подключаем стили данной страницы-->
	...
	<script type="text/javascript" src="<?php echo("$page_massive[js_page]")?>kontakty.js"></script> <!--Подключаем скрипты для данной страницы-->
